...
public class MessageVerifyUtils {
     ...
     * Integer.toString(getNewcode()); SendSmsResponse sendSms
     * =sendSms("13633439294",code);//填写你需要测试的手机号码
     * System.out.println("短信接口返回的数据----------------"); System.out.println("Code=" +
     * sendSms.getCode()); System.out.println("Message=" + sendSms.getMessage());
